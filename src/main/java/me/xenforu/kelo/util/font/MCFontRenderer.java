...
public class    MCFontRenderer extends CFont
{
        ...
        if (getStringWidth(text) > width)
        {
            ...
            for (String word : words)
            {
                ...
                else
                {
                    ...
                    currentWord = ChatFormatting.PREFIX_CODE + lastColorCode + word + " ";
                }
            }

            if (currentWord.length() > 0) if (getStringWidth(currentWord) < width)
            {
                finalWords.add(ChatFormatting.PREFIX_CODE + lastColorCode + currentWord + " ");
                currentWord = "";
            }
            else
            {
    ...
    public List<String> formatString(String string, double width)
    {
        ...
        for (int i = 0; i < chars.length; i++)
        {
            ...
            {
                finalWords.add(currentWord);
                currentWord = ChatFormatting.PREFIX_CODE + lastColorCode + String.valueOf(c);
            }
        }
