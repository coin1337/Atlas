...
public class KeybindComponent extends Component {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        Fonts.arialFont.drawStringWithShadow(isBinding() ? "...":"Bind: " + Keyboard.getKeyName(getToggleableModule().getBind()), getFinishedX() + 6, getFinishedY() + 0.5f+ getHeight() / 2 - Fonts.arialFont.getStringHeight(getLabel()) / 2, 0xFFFFFFFF);
    }
