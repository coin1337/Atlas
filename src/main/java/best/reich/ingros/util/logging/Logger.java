...
public class Logger implements Minecraftable {
    ...
    public static void printMessage(String message,boolean notification) {
        mc.ingameGUI.getChatGUI().printChatMessage(new TextComponentString(ChatFormatting.GREEN + "<" + ChatFormatting.RED + "Atlas" + ChatFormatting.GREEN + "> " + ChatFormatting.GRAY +  message));
        if (notification)
